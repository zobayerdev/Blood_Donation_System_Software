...
public class deleteDonor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton4.setFont(new java.awt.Font("Tinos", 1, 18)); // NOI18N
        ...
        setSize(new java.awt.Dimension(795, 508));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int rt = Integer.parseInt(donorId);
        try{
        Connection con = ConnectionProvider.getCon();
        Statement st = con.createStatement();
        st.executeUpdate("DELETE FROM donor WHERE donorID = '" + rt +"'");
        JOptionPane.showMessageDialog(null, "Sussessfully Deleted");
        setVisible(false);
